...
**Execution:**
- [x] Append the clarification and V14 overlays; carry DC-9–DC-11, exact A4→16.1/A5→16.2/A6→16.3 mappings, checkpoint nodes, and hold semantics.
- [x] Give each Story 16 contract six non-vacuous scenarios and two final-record paths. AC-01–05 use the matching `verify_story_16_1.py`, `verify_story_16_2.py`, or `verify_story_16_3.py`; each command's `--scenario` and output basename equal its literal AC ID. AC-06 uses `generate_story_record.py`.
- [x] Extend publisher/schema routing for 30 contracts and 38 nodes/61 edges; preserve historical authorities; regenerate all companions.
- [x] Extend evidence validation and preflight to compare baseline..C2 with the declared source/generated allowlist and reject every mode-160000 delta.
- [x] Add Python/C# positive and fault tests for mappings, frozen bytes, sidecars, graph, lifecycle neutrality, rollback, and non-vacuity.
- [x] Validate C1, publish against C1, rebind the live companion, create C2, and run all gates against C2.
...
- 2026-08-19: Human approved adding the hermetic F-10 verification repair to
  the publication allowlist while preserving the two-commit transaction.
...
**Authority and successor design**

- Start with the approved successor mapping, inventories, and preserved active hold.
  [`sprint-change-proposal-2026-08-18.md:146`](../planning-artifacts/sprint-change-proposal-2026-08-18.md#L146)

- The append-only epic overlay makes Story 16 contracts and graph predecessors canonical.
  [`epics.md:4357`](../planning-artifacts/prds/prd-Conversations-2026-06-02/epics.md#L4357)

- The architecture overlay fixes ownership, replay, diagnostics, and publication invariants.
  [`architecture.md:2627`](../planning-artifacts/architecture.md#L2627)

**Publication and schema binding**

- Candidate rendering composes every source, contract, projection, and bundle deterministically.
  [`publish_v9_planning_authority.py:2044`](../../_bmad/scripts/publish_v9_planning_authority.py#L2044)

- Proposal inventories and Story 16 commands are independently parsed and exactly validated.
  [`publish_v9_planning_authority.py:730`](../../_bmad/scripts/publish_v9_planning_authority.py#L730)

- Effective V14 contracts use a distinct additive schema identity.
  [`v14-story-contract-v1.schema.json:9`](../../_bmad/schemas/v14-story-contract-v1.schema.json#L9)

- The point-in-time checkpoint refuses rebinding to a different well-formed candidate.
  [`publish_v14_current_candidate_authority.py:39`](../../_bmad/scripts/publish_v14_current_candidate_authority.py#L39)

**Candidate boundary and generated projections**

- The candidate-bound manifest closes the exact 67-path, zero-gitlink publication scope.
  [`v14-planning-publication-scope-v1.json:2`](../planning-artifacts/v14-planning-publication-scope-v1.json#L2)

- Raw gitlink and candidate-manifest validation fail closed before publication checks.
  [`verify_evidence_boundary.py:325`](../../_bmad/scripts/verify_evidence_boundary.py#L325)

- CI applies the same baseline-to-candidate evidence boundary.
  [`planning-authority-preflight.yml:66`](../../.github/workflows/planning-authority-preflight.yml#L66)

- The generated graph exposes the exact 38-node, 61-edge executable dependency model.
  [`v9-execution-graph-v1.json:9`](../planning-artifacts/v9-execution-graph-v1.json#L9)

- Sprint projection preserves the active hold and leaves Epic 16 in backlog.
  [`sprint-status.yaml:133`](sprint-status.yaml#L133)

**Verification and fault coverage**

- Publication tests cover deterministic composition, schema routing, mappings, rollback, and drift.
  [`test_publish_v9_planning_authority.py:110`](../../_bmad/scripts/tests/test_publish_v9_planning_authority.py#L110)

- Caller-path tests prove dirty manifests and unlisted candidate paths cannot pass.
  [`test_verify_evidence_boundary.py:371`](../../_bmad/scripts/tests/test_verify_evidence_boundary.py#L371)

- F-10 now uses a controlled dirty tracked file without ambient skips.
  [`test_verify_epic_6_completion_supersession.py:478`](../../_bmad/scripts/tests/test_verify_epic_6_completion_supersession.py#L478)

- Independent C# validation checks V14 preservation, contracts, bundle, and graph parity.
  [`PlanningAuthorityV9ValidationTest.cs:50`](../../tests/Hexalith.Conversations.Conformance.Tests/PlanningAuthorityV9ValidationTest.cs#L50)
