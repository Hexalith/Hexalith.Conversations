...
internal static class ContractSamples
{
    ...
    [
        ...
        ConformanceManifestLifecycleStage.DesignReview,
        ConformanceManifestLifecycleStage.AutomatedTest,
        ConformanceManifestLifecycleStage.ReleaseEvidence,
        new ConformanceManifestRowV1(
            "sample-manifest-row",
            "Sample manifest row for contract scan",
            "FR83",
            null,
            null,
            "Row validates with zero errors in the contract scan",
            ReleaseGateStatus.Pass,
            null,
        ...
        new ConformanceManifestChangeV1(
            "change-sample-001",
            "Initial manifest version created for contract scan coverage",
            ["FR83", "FR84"],
            new DateTimeOffset(2026, 5, 23, 0, 0, 0, TimeSpan.Zero),
            "release-engineer"),
        ...
        WaiverLifecycleStatus.Rejected,
        WaiverLifecycleStatus.Superseded,
        new ReleaseWaiverV1(
            "waiver-sample-001",
            "release-engineer",
            "release-approver",
            ...
            "Waiver schema document and fixture provide navigable governance evidence for release approvers",
            new DateTimeOffset(2027, 1, 1, 0, 0, 0, TimeSpan.Zero),
            "Buyer can review named waivers through release evidence documents",
            null,
            ["release-waiver-v1-fixture", "waiver-schema-doc"],
            new DateTimeOffset(2026, 12, 1, 0, 0, 0, TimeSpan.Zero),
            WaiverLifecycleStatus.Active,
            new DateTimeOffset(2026, 5, 23, 0, 0, 0, TimeSpan.Zero)),
        new ReleaseWaiverV1(
            "waiver-blocker-sample-001",
            "release-engineer",
            "release-approver",
            "NFR62",
            ReleaseGateId.TenantIsolation,
            ["5-4-support-named-waivers-for-release-gate-exceptions"],
            true,
            "Tenant isolation gate requires explicit named approval",
            "Manual review performed by release approver with audit trail",
            new DateTimeOffset(2027, 6, 1, 0, 0, 0, TimeSpan.Zero),
            "Tenant isolation controls are in place but require periodic named waiver review",
            "buyer-accepted",
            [],
            new DateTimeOffset(2027, 1, 1, 0, 0, 0, TimeSpan.Zero),
            WaiverLifecycleStatus.Active,
