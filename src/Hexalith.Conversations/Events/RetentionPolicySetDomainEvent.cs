// <copyright file="RetentionPolicySetDomainEvent.cs" company="ITANEO">
...
/// <summary>
/// Records a governed retention policy set mutation.
/// </summary>
...
public sealed record RetentionPolicySetDomainEvent(
    ...
    string? IdempotencyKey = null) : IEventPayload
{
    ...
    /// <summary>
    /// Gets the active public retention policy reference.
    /// </summary>
    ...
    public override string ToString()
    {
        ...
        builder
            .Append(nameof(RetentionPolicySetDomainEvent))
