// <copyright file="MessageContentRedactedDomainEvent.cs" company="ITANEO">
...
/// <summary>
/// Records governed redaction intent for message content.
/// </summary>
...
public sealed record MessageContentRedactedDomainEvent(
    ...
    string? IdempotencyKey = null) : IEventPayload
{
    ...
    /// </summary>
    public DateTimeOffset RedactedAt => Metadata.CommittedAt;
    ...
    public override string ToString()
    {
        ...
        builder
            .Append(nameof(MessageContentRedactedDomainEvent))
