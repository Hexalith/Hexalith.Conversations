// <copyright file="ConversationSensitivityMarkState.cs" company="ITANEO">
...
/// <summary>
/// Replay-only active sensitivity mark state for one governed target.
/// </summary>
...
/// <param name="MarkedAt">The event timestamp recorded by the aggregate.</param>
/// <param name="AuditEvidence">The safe audit evidence paired with the mutation.</param>
public sealed record ConversationSensitivityMarkState(
    string TargetKey,
