// <copyright file="ProjectReferenceHydrationV1.cs" company="ITANEO">
...
/// <summary>
/// Carries response-scoped project reference hydration.
/// </summary>
public sealed record ProjectReferenceHydrationV1(
    ProjectId ProjectId,
