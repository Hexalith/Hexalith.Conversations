// <copyright file="PartyReferenceHydrationV1.cs" company="ITANEO">
...
/// <summary>
/// Carries response-scoped Party reference hydration without upstream personal data.
/// </summary>
public sealed record PartyReferenceHydrationV1(
    PartyId PartyId,
    ...
    string SafeStatus)
{
    ...
    /// </summary>
    public PartyId PartyId { get; } = PartyId ?? throw new ArgumentNullException(nameof(PartyId));
    ...
    /// <summary>
    /// Gets the policy-approved availability/status or fallback status.
    /// </summary>
