// <copyright file="ConversationSensitivityMarkResult.cs" company="ITANEO">
...
/// <summary>
/// Reports the sanitized outcome of a governed sensitivity-mark command.
/// </summary>
...
/// <param name="category">The bounded sensitivity category when policy allows disclosure.</param>
...
public sealed record ConversationSensitivityMarkResult(
